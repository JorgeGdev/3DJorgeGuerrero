...
export default function JavascriptLogo(props) { // Usamos props para manejar escala y posición desde fuera
  const { scene, animations } = useGLTF('../models/bubble/javascript.glb');
