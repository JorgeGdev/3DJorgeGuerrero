...
export default function GithubLogo(props) { // Usamos props para manejar escala y posición desde fuera
  const { scene, animations } = useGLTF('../models/bubble/github.glb');
