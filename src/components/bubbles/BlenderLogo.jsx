...
export default function BlenderLogo(props) { // Usamos props para manejar escala y posición desde fuera
  const { scene, animations } = useGLTF('../models/bubble/blender.glb');
