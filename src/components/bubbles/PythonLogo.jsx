...
export default function PythonLogo(props) { // Usamos props para manejar escala y posición desde fuera
  const { scene, animations } = useGLTF('../models/bubble/python.glb');
